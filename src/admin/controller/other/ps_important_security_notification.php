<?php
namespace Opencart\Admin\Controller\Extension\PsImportantSecurityNotification\Other;
/**
 * Class PsImportantSecurityNotification
 *
 * @package Opencart\Admin\Controller\Extension\PsImportantSecurityNotification\Other
 */
class PsImportantSecurityNotification extends \Opencart\System\Engine\Controller
{
    /**
     ...
     */
    const EXTENSION_DOC = 'https://github.com/playfulsparkle/oc4_important_security_notification.git';
    ...
    {
        $this->load->language('extension/ps_important_security_notification/other/ps_important_security_notification');
        ...
        $data['action'] = $this->url->link('extension/ps_important_security_notification/other/ps_important_security_notification' . $separator . 'save', 'user_token=' . $this->session->data['user_token']);
        $data['back'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=other');

        $data['other_ps_important_security_notification_status'] = (bool) $this->config->get('other_ps_important_security_notification_status');
        ...
        $this->response->setOutput($this->load->view('extension/ps_important_security_notification/other/ps_important_security_notification', $data));
    }
    ...
    public function save(): void
    {
        ...
        if (!$this->user->hasPermission('modify', 'extension/ps_important_security_notification/other/ps_important_security_notification')) {
        ...
        if (!$json) {
            ...
            $this->model_setting_setting->editSetting('other_ps_important_security_notification', $this->request->post);
    ...
    {
        $this->model_setting_event->deleteEventByCode('other_ps_important_security_notification');
    }
    ...
    private function registerEvents(): int
    {
        ...
        if (version_compare(VERSION, '4.0.1.0', '>=')) {
            $result = $this->model_setting_event->addEvent([
                'code' => 'other_ps_important_security_notification',
                'description' => '',
                'trigger' => 'admin/view/common/dashboard/before',
                'action' => 'extension/ps_important_security_notification/other/ps_important_security_notification' . $separator . 'eventAdminViewCommonDashboardBefore',
                'status' => '1',
                'sort_order' => '0'
            ]);
        } else {
            $result = $this->model_setting_event->addEvent(
                'other_ps_important_security_notification',
                '',
                'admin/view/common/dashboard/before',
                'extension/ps_important_security_notification/other/ps_important_security_notification' . $separator . 'eventAdminViewCommonDashboardBefore'
            );
        }
